...
$query_rsJenisRead = "SELECT * FROM tb_jenis_kendaraan ORDER BY jenis_kendaraan ASC";
...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-col m8 l9 w3-padding-large"><!-- InstanceBeginEditable name="EditRegion1" --><div class="w3-large w3-border-bottom" style="padding-bottom:8px;">Data Jenis Kendaraan</div>
<?php if ($totalRows_rsJenisRead > 0) { // Show if recordset not empty ?>
  <div class="w3-row">
 	<div class="w3-col l3" style="padding-right:4px;"><a style="margin-top:8px; height:36px;" onClick="document.getElementById('loading').style.display='block'" class="w3-btn w3-block w3-green w3-small" href="jenis_create.php"><i class="fa fa-plus fa-fw"></i> Tambah Data</a></div>
    ...
    <div class="w3-col l6" style="padding-left:4px;"><div class="w3-border w3-border-yellow w3-pale-yellow w3-padding w3-small" style="margin-top:8px;">
        Total Data<span class="w3-right"><?php echo $totalRows_rsJenisRead ?></span>
        </div></div>
</div>
  ...
  <table class="w3-table w3-striped w3-small w3-hoverable w3-bordered w3-border" id="jenis" style="margin-top:8px;">
    ...
    <?php do { ?>
      <tr class="jenis">
        <td><?php echo $row_rsJenisRead['jenis_kendaraan']; ?><span class="w3-right"><a class="w3-tag w3-small w3-green" style="text-decoration:none" onClick="document.getElementById('loading').style.display='block'" href="jenis_update.php?id_jenis_kendaraan=<?php echo $row_rsJenisRead['id_jenis_kendaraan']; ?>">Ubah</a> <a class="w3-tag w3-small w3-red" style="text-decoration:none" onclick="return confirm('Anda Yakin Ingin Menghapus?\nJenis Kendaraan : <?php echo $row_rsJenisRead['jenis_kendaraan']; ?>')" href="jenis_delete.php?id_jenis_kendaraan=<?php echo $row_rsJenisRead['id_jenis_kendaraan']; ?>">Hapus</a></span></td>
      </tr>
