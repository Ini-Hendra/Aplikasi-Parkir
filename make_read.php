...
<div><form id="form1" name="form1" method="post" action="make_jenis.php">
...
<div><form id="form3" name="form3" method="post" action="make_periode.php">
<div class="w3-row">
...
<div><form id="form2" name="form2" method="post" action="make_bulanan.php">
<div class="w3-row">
