...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-col m8 l9 w3-padding-large"><!-- InstanceBeginEditable name="EditRegion1" --><div class="w3-large w3-border-bottom" style="padding-bottom:8px;"><a style="cursor:pointer" onClick="window.history.back();document.getElementById('loading').style.display='block'"><i class="fa fa-arrow-left"></i></a> &nbsp;&nbsp;Tambah Petugas Parkir</div>
        <table class="w3-table w3-border" style="margin-top:8px;">
    <tr>
      <td class="w3-center">Username Sudah Digunakan<br>
Mohon Gunakan Username Yang Lain</td>
      </tr>
    </table>
		<!-- InstanceEndEditable -->
