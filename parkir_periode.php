...
$query_rsPendapatanPeriode = sprintf("SELECT * FROM tb_parkir WHERE date(masuk) BETWEEN %s AND %s AND status='Masuk' ORDER BY masuk DESC", GetSQLValueString($colname_rsPendapatanPeriode, "date"),GetSQLValueString($colname_rsPendapatanPeriode2, "date"));
...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-large w3-border-bottom" style="padding-bottom:8px;">Kendaraan Di Lokasi Parkir</div>
...
<?php
  ...
  <div class="w3-row">
    ...
    <div class="w3-col l9" style="padding-left:4px;"><div class="w3-border w3-border-yellow w3-pale-yellow w3-padding w3-small" style="margin-top:8px;">
        Sub Total <?php echo $day3."-".$mont3."-".$year3 ?> Sampai <?php echo $day4."-".$mont4."-".$year4 ?><span class="w3-right"><?php echo $totalRows_rsPendapatanPeriode ?></span>
        </div></div>
</div>
