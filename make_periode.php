...
$query_rsPendapatanPeriode = sprintf("SELECT * FROM tb_parkir WHERE date(masuk) BETWEEN %s AND %s ORDER BY masuk DESC", GetSQLValueString($colname_rsPendapatanPeriode, "date"),GetSQLValueString($colname_rsPendapatanPeriode2, "date"));
...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-large w3-border-bottom" style="padding-bottom:8px;">Kendaraan Masuk & Keluar Berdasarkan Periode</div>
