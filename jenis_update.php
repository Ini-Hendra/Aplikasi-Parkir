...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tb_jenis_kendaraan SET jenis_kendaraan=%s WHERE id_jenis_kendaraan=%s",
...
if (isset($_GET['id_jenis_kendaraan'])) {
  $colname_rsJenisUpdate = $_GET['id_jenis_kendaraan'];
}
mysql_select_db($database_koneksi, $koneksi);
$query_rsJenisUpdate = sprintf("SELECT * FROM tb_jenis_kendaraan WHERE id_jenis_kendaraan = %s", GetSQLValueString($colname_rsJenisUpdate, "text"));
...
<title>UBAH JENIS KENDARAAN</title>
<!-- InstanceEndEditable -->
...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-large w3-border-bottom" style="padding-bottom:8px;"><a style="cursor:pointer" onClick="window.history.back();document.getElementById('loading').style.display='block'"><i class="fa fa-arrow-left"></i></a> &nbsp;&nbsp;Ubah Jenis Kendaraan</div>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" align="center" style="margin-top:8px;">
    <tr valign="baseline" style="display:none">
      <td nowrap="nowrap" align="right">Id_jenis_kendaraan:</td>
      <td><?php echo $row_rsJenisUpdate['id_jenis_kendaraan']; ?></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap">Jenis Kendaraan</td>
      <td><input type="text" class="w3-input w3-border w3-small" required name="jenis_kendaraan" value="<?php echo htmlentities($row_rsJenisUpdate['jenis_kendaraan'], ENT_COMPAT, ''); ?>" size="32" /></td>
    </tr>
  ...
  <input type="hidden" name="id_jenis_kendaraan" value="<?php echo $row_rsJenisUpdate['id_jenis_kendaraan']; ?>" />
</form>
<br>
