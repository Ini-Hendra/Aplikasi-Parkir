...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-large w3-border-bottom" style="padding-bottom:8px;">Laporan Pendapatan</div>
<div class="w3-row">
        	<div class="w3-col s4 l4" style="padding-right:4px;"><ul class="w3-ul w3-border w3-small" style="margin-top:8px;">
  <li class="w3-blue"><i class="fa fa-print fa-fw"></i><strong>Jenis Parkir</strong></li>
  <li>
  	<div class="w3-pale-yellow w3-center w3-small w3-border" style="padding:0px;">
  <p>Silahkan Pilih Jenis Parkir</p>
</div>
<div><form id="form1" name="form1" method="post" action="pendapatan_jenis.php">
  <select name="txtJenis" class="w3-input w3-border w3-small" required style="cursor:pointer;margin-top:8px;">
<option value="">Pilih Jenis Kendaraan</option>
  ...
  <button type="submit" class="w3-btn w3-block w3-green" style="margin-top:8px;"><i class="fa fa-print fa-fw"></i> Cetak</button>
</form></div>
  </li>
</ul></div>
            <div class="w3-col s4 l4" style="padding-left:4px; padding-right:4px;"><ul class="w3-ul w3-border w3-small" style="margin-top:8px;">
  <li class="w3-blue"><i class="fa fa-print fa-fw"></i><strong>Per Periode</strong></li>
  <li>
  <div class="w3-pale-yellow w3-center w3-small w3-border" style="padding:0px;">
  <p>Silahkan Pilih Periode</p>
</div>
<div><form id="form3" name="form3" method="post" action="pendapatan_periode.php">
<div class="w3-row">
	<div class="w3-col s6 l6" style="padding-right:2px;"><input class="w3-input w3-border w3-small" required placeholder="" style="margin-top:8px;" type="date" name="tglAwal" value="<?php echo date('Y-m-d'); ?>" /></div>
    <div class="w3-col s6 l6" style="padding-left:2px;"><input class="w3-input w3-border w3-small" required placeholder="" style="margin-top:8px;" type="date" name="tglAkhir" value="<?php echo date('Y-m-d'); ?>" /></div>
</div>
  <button type="submit" class="w3-btn w3-block w3-green" style="margin-top:8px;"><i class="fa fa-print fa-fw"></i> Cetak</button>
</form></div>
  </li>
</ul></div>
            <div class="w3-col s4 l4" style="padding-left:4px;"><ul class="w3-ul w3-border w3-small" style="margin-top:8px;">
  <li class="w3-blue"><i class="fa fa-print fa-fw"></i><strong>Bulanan</strong></li>
  <li>
  <div class="w3-pale-yellow w3-center w3-small w3-border" style="padding:0px;">
  <p>Silahkan Pilih Bulan & Tahun</p>
</div>
<div><form id="form2" name="form2" method="post" action="pendapatan_bulanan.php">
<div class="w3-row">
	<div class="w3-col s6 l6" style="padding-right:2px;"><select name="txtBulan" class="w3-input w3-border w3-small" required placeholder="" style="margin-top:8px;height:38px;">
            <option value="">Pilih Bulan</option>
                  <option value="01" <?php if (!(strcmp("01", ""))) {echo "SELECTED";} ?>>Januari</option>
                  <option value="02" <?php if (!(strcmp("02", ""))) {echo "SELECTED";} ?>>Februari</option>
                   <option value="03" <?php if (!(strcmp("03", ""))) {echo "SELECTED";} ?>>Maret</option>
                    <option value="04" <?php if (!(strcmp("04", ""))) {echo "SELECTED";} ?>>April</option>
                     <option value="05" <?php if (!(strcmp("05", ""))) {echo "SELECTED";} ?>>Mei</option>
                      <option value="06" <?php if (!(strcmp("06", ""))) {echo "SELECTED";} ?>>Juni</option>
                       <option value="07" <?php if (!(strcmp("07", ""))) {echo "SELECTED";} ?>>Juli</option>
                        <option value="08" <?php if (!(strcmp("08", ""))) {echo "SELECTED";} ?>>Agustus</option>
                         <option value="09" <?php if (!(strcmp("09", ""))) {echo "SELECTED";} ?>>September</option>
                          <option value="10" <?php if (!(strcmp("10", ""))) {echo "SELECTED";} ?>>Oktober</option>
                           <option value="11" <?php if (!(strcmp("11", ""))) {echo "SELECTED";} ?>>November</option>
                            <option value="12" <?php if (!(strcmp("12", ""))) {echo "SELECTED";} ?>>Desember</option>
                             
                </select></div>
    <div class="w3-col s6 l6" style="padding-left:2px;"><select name="txtTahun" class="w3-input w3-border w3-small" required placeholder="" style="margin-top:8px;height:38px;">
  <?php
$mulai= date('Y') - 10;
