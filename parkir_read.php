...
<br><br><br><br>
  ...
  <a onClick="return confirm('Anda Yakin Ingin Keluar?')" href="<?php echo $logoutAction ?>" style="text-decoration:none"><li class="w3-hover-pale-blue"><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
        ...
        <div class="w3-large w3-border-bottom" style="padding-bottom:8px;">Data Laporan Parkir</div>
        <div class="w3-row">
...
<div><form id="form1" name="form1" method="post" action="parkir_jenis.php">
...
<div><form id="form3" name="form3" method="post" action="parkir_periode.php">
<div class="w3-row">
...
<div><form id="form2" name="form2" method="post" action="parkir_bulanan.php">
<div class="w3-row">
